...
<section>
    <div class="container_sidenav">
      <div class="card grey darken-4 white-text">
        <h4 class="center-align">Producto 1</h4>
        <?php echo form_open_multipart('producto/store');?>
            <div class="row">
                ...
                <div class="file-path-wrapper">
                    ...
                    <input placeholder="Categoria" id="first_name" type="text" class="validate white-text" name = "Categoria">
                    <label for="first_name"></label>
                    </div>
                    <div class="input-field col s12 m6">
                        <i class="material-icons prefix">attach_money</i>
                        <input placeholder="0" id="first_name" type="number" class="validate white-text" name="Precio">
                        <label for="first_name">Precio</label>
                    </div>
                    <div class="input-field col s12 m6">
                        <input placeholder="0" id="first_name" type="number" class="validate white-text" name= "Cantidad">
                        <label for="first_name">Cantidad</label>
                    </div>
                    <div class="input-field col s12 m12">
                            <input placeholder="azul, verde, rosado" id="first_name" type="text" class="validate white-text" name = "Color">
