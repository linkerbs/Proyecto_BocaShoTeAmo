      ...
      <div class="card grey darken-4 white-text">
        ...
        <form class="col s12">
          <div class="row container_buscador">
            ...
            <div class="col s3 m2">
                <a href="<?= site_url('/producto/create'); ?>" class="waves-effect red darken-2 btn botton-abajo"><i class="material-icons">add</i></a>
            </div>
          </div>
        </form>
          ...
          <?php foreach ($data as $list): ?>
            <tr>
                <tr>
                    ...
                    <td><img class="img_logo" src="<?php echo base_url();?>assets/img/producto/<?php echo $list->Logo; ?>" alt="logo"></td>
                    <td>
                    <form method="DELETE" action="<?php echo base_url('index.php/producto/delete/'.$list->Id);?>">
                       <a href="<?php echo base_url('index.php/producto/edit/'.$list->Id)?>"><i class="material-icons blue-text">edit</i></a>
