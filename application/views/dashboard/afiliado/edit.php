...
<section>
    <div class="container_sidenav">
      <div class="card grey darken-4 white-text">
        <h4 class="center-align">Editando <?php echo $afiliado->Nombre?></h4>
        <?php echo form_open_multipart('afiliado/update/'.$afiliado->Id);?>
          <div class="row">
            <div class="input-field col s12 m6">
                <input placeholder="Nombrer" id="first_name" type="text" class="validate white-text" value = "<?php echo $afiliado->Nombre?>" name = "Nombre">
