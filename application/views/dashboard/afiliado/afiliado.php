      ...
      <div class="sidenav_space">
        <div class="container_sidenav">
          <div class="card grey darken-4 white-text">
            <h3 class="center-align">Lista de Afiliados</h3>
            <form class="col s12">
              <div class="row container_buscador">
                ...
                <div class="col s3 m2">
                    <a href="<?= site_url('/afiliado/create'); ?>" class="waves-effect red darken-2 btn botton-abajo"><i class="material-icons">add</i></a>
                </div>
              </div>
            </form>
              ...
              <?php foreach ($data as $list): ?>
                <tr>
                    <tr>
                        ...
                        <td><img class="img_logo" src="<?php echo base_url();?>assets/img/afiliado/<?php echo $list->Logo; ?>" alt="logo"></td>
                        <td>
