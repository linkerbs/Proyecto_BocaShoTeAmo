...
<section>
  <div class="sidenav_space">
    <div class="container_sidenav">
      ...
      <?php echo form_open_multipart('dashboard/contra');?>
          <div class="row container_buscador">
            ...
            <div class="input-field col s12 m6">
                ...
                <input placeholder="" id="first_name" type="password" class="validate white-text" name ="Constraseñan">
                <label for="first_name">Contraseña nueva</label>
            </div>
           
            <div class="col s12 m12 right">
                <button type="Submit" class="waves-effect red darken-3 btn right">Aceptar</a>
                <br><br>
            </div>
           </div>
        </form>
